  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="galleryApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="galleryApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('galleryApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('galleryApp.employee.lastName')}
                id="employee-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField label={translate('galleryApp.employee.email')} id="employee-email" name="email" data-cy="email" type="text" />
              <ValidatedField
                label={translate('galleryApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('galleryApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('galleryApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('galleryApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="managerId"
                data-cy="manager"
                label={translate('galleryApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="departmentId"
                data-cy="department"
                label={translate('galleryApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
