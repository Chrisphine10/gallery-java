  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="galleryApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="galleryApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('galleryApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('galleryApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('galleryApp.jobHistory.language')}
                id="job-history-language"
                name="language"
                data-cy="language"
                type="select"
              >
                <option value="FRENCH">{translate('galleryApp.Language.FRENCH')}</option>
                <option value="ENGLISH">{translate('galleryApp.Language.ENGLISH')}</option>
                <option value="SPANISH">{translate('galleryApp.Language.SPANISH')}</option>
              </ValidatedField>
              <ValidatedField id="job-history-job" name="jobId" data-cy="job" label={translate('galleryApp.jobHistory.job')} type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="departmentId"
                data-cy="department"
                label={translate('galleryApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employeeId"
                data-cy="employee"
                label={translate('galleryApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
