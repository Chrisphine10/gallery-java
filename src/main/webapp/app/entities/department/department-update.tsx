  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="galleryApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="galleryApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('galleryApp.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="locationId"
                data-cy="location"
                label={translate('galleryApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
